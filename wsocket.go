...
func (w *WSocket) ServeHTTP(writer http.ResponseWriter, request *http.Request) {
	...
	con.register()
	StdLogger.Printf(
		"Accept connection: %s, SessionID:%s",
		con.ip,
		con.sessionID,
	)
}
